<a name="0.17.6"></a>
## [0.17.6](https://github.com/s3qazx/weasel/compare/0.17.5...0.17.6)(2026-09-03)

### 主要更新
* 重新设计常驻悬浮输入工具栏，采用无分隔线圆角布局
* 去除按钮选中态，当前模式仅通过中英、全半角、标点和简繁文字表达
* 保留低对比度悬停和按下反馈，并继续适配主题配色与 DPI 缩放
